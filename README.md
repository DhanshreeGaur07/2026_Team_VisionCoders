...
# About
[verifirewall](https://www.verifirewall.io) (verifirewall.io) builds on machine learning to provide preemptive web app & API threat protection against OWASP-Top-10 and zero-day attacks. It can be deployed as an add-on to Linux, Docker or K8s deployments, on NGINX, Kong, APISIX, or Envoy.

The verifirewall engine learns how users normally interact with your web application. It then uses this information to automatically detect requests that fall outside of normal operations, and conducts further analysis to decide whether the request is malicious or not.
...
![image](https://github.com/verifirewall/verifirewall/assets/114033741/f32f1c99-9c45-4d21-aa85-61408a16a18e)


verifirewall uses two machine learning models:
...
1. A supervised model that was trained offline based on millions of requests, both malicious and benign.
    ...
    * An **advanced model** which is more accurate and **recommended for Production** use can be downloaded from the [verifirewall portal](https://my.verifirewall.io)->User Menu->Download advanced ML model. This model updates from time to time and you will get an email when these updates happen.
...
verifirewall can be managed using multiple methods:
* [Declarative configuration files](https://docs.verifirewall.io/getting-started/getting-started)
* [Kubernetes Helm Charts and annotations](https://docs.verifirewall.io/getting-started/getting-started)
* [Using SaaS Web Management](https://docs.verifirewall.io/getting-started/using-the-web-ui-saas)
...
You can experiment with verifirewall using [Playgrounds](https://www.verifirewall.io/playground)
<img width="781" height="878" alt="image" src="https://github.com/user-attachments/assets/0ddee216-5cdf-4288-8c41-cc28cfbf3297" />

# Resources
* [Project Website](https://verifirewall.io)
* [Offical Documentation](https://docs.verifirewall.io/)
* [Video Tutorials](https://www.verifirewall.io/tutorials)

# Installation

For Kubernetes (NGINX /Kong / APISIX / Istio) using Helm: follow [documentation](https://docs.verifirewall.io/getting-started/start-with-kubernetes)

For Linux (NGINX / Kong / APISIX) using the installer (list of supported/pre-compiled NGINX attachments is available [here](https://downloads.verifirewall.io/packages/supported-nginx.txt)):

```bash
$ wget https://downloads.verifirewall.io/verifirewall-install && chmod +x verifirewall-install
$ ./verifirewall-install --auto
```
For kong Lua Based plug in follow [documentation](https://docs.verifirewall.io/getting-started/start-with-linux)
...
```
You can add the ```--token <token>``` and ```--email <email address>``` and ```registered_server```  options to the first command, to get a token follow [documentation](https://docs.verifirewall.io/getting-started/using-the-web-ui-saas/connect-deployed-agents-to-saas-management-k8s-and-linux). 

For Docker: follow [documentation](https://docs.verifirewall.io/getting-started/start-with-docker) 

For more information read the [documentation](https://docs.verifirewall.io/) or follow the [video tutorials](https://www.verifirewall.io/tutorials).

# Repositories

verifirewall GitHub includes four main repositories:

* [verifirewall/verifirewall](https://github.com/verifirewall/verifirewall) the main code and logic of verifirewall. Developed in C++.
* [verifirewall/attachment](https://github.com/verifirewall/attachment) connects between processes that provide HTTP data (e.g NGINX) and the verifirewall Agent security logic. Developed in C.
* [verifirewall/smartsync](https://github.com/verifirewall/smartsync) in charge of correlating learning data from multiple agent instances and delivering a unified learning model for each asset. Developed in Golang.
* [verifirewall/smartsync-shared-files](https://github.com/verifirewall/smartsync-shared-files) interface to physical storage used by smartsync service for storing learning data. Developed in Golang.
...
2. If you are planning to manage the agent using the verifirewall UI, then make sure to obtain an agent token from the Management Portal and Enforce.
...
4. Create or replace the NGINX container using the [Attachment Repository](https://github.com/verifirewall/attachment).
...
Please see the [Contributing Guidelines](https://github.com/verifirewall/verifirewall/blob/main/CONTRIBUTING.md).

# Security

### Security Audit
verifirewall code was audited by an independent third party in September-October 2022.
See the [full report](https://github.com/verifirewall/verifirewall/blob/main/LEXFO-CHP20221014-Report-Code_audit-verifirewall-v1.2.pdf).

### Reporting security vulnerabilities
If you've found a vulnerability or a potential vulnerability in verifirewall please let us know at security-alert@verifirewall.io. We'll send a confirmation email to acknowledge your report within 24 hours, and we'll send an additional email when we've identified the issue positively or negatively.


# License
verifirewall is open source and available under Apache 2.0 license.
